      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-400 leading-relaxed">
              From First Contact to Results—We Deliver. AI-powered B2B outreach that scales your sales pipeline.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">
                <Twitter className="w-5 h-5" />
              </a>
              <a href="https://www.linkedin.com/company/leadsnlink/" className="text-gray-400 hover:text-blue-400 transition-colors">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span>hello@leadsnlinks.com</span>
              </div>
             
              <div className="flex items-center space-x-3">
                <MapPin className="w-5 h-5 text-blue-400" />
                <span>Pune & Bangalore</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-sm text-gray-400">
            © 2025 Leads N Links. All rights reserved.
          </div>
